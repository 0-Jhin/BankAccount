package bank.account.domain.inquery.service;

import bank.account.domain.inquery.dao.InQueryRepository;
import bank.account.domain.inquery.exception.InQueryException;
import bank.account.domain.inquery.model.InQuery;
import bank.account.domain.user.application.UserService;
import bank.account.domain.user.exception.UserException;
import bank.account.domain.user.model.User;
import bank.account.domain.user.model.UserRole;
...
import static bank.account.domain.inquery.dto.InQueryDto.*;

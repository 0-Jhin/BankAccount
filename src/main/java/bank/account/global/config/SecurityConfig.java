package bank.account.global.config;

import com.fasterxml.jackson.databind.ObjectMapper;
import bank.account.domain.token.repository.BlacklistedTokenRepository;
import bank.account.domain.token.repository.RefreshTokenRepository;
import bank.account.domain.user.dao.UserRepository;
import bank.account.global.oauth.handler.OAuthLoginFailureHandler;
import bank.account.global.oauth.handler.OAuthLoginSuccessHandler;
import bank.account.global.oauth.handler.OAuthLogoutHandler;
import bank.account.global.oauth.service.CustomOAuth2UserService;
import bank.account.global.security.filter.JwtAuthenticationProcessingFilter;
